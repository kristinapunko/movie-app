...
const MovieDetails = () => {
  ...
  return (
    <View className='bg-primary flex-1'>
      <ScrollView contentContainerStyle={{paddingBottom: 80}}>
        ...
        <View className='flex-col items-start justify-center mt-5 px-5'>
          ...
          <MovieInfo label='Genres' value={movie?.genres?.map((g)=>g.name).join('-') || 'N/A'} />
            <View className='flex flex-row gap-8 w-1/2'>
      ...
      <TouchableOpacity className='absolute w-[90%] bottom-5 left-0 ring-0 mx-5 bg-accent rounded-lg py-3.5 flex flex-row items-center justify-center z-50' onPress={router.back}>
